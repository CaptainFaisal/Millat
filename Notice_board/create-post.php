...
if(in_array($fileExtName,$allowed)){
    ...
    $fileErr = "You can not upload this type of file.Only ".(implode(",",$allowed))." are allowed.";
}


$sql="INSERT INTO  post(Title,Description,Files) VALUES(:title,:description,:files)";
$query = $dbh->prepare($sql);
$query->bindParam(':title',$title,PDO::PARAM_STR);
$query->bindParam(':description',$textarea,PDO::PARAM_STR);
                ...
                <div class="main-page">
                    ...
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-6">
                                <h2 class="title">Post Creation</h2>
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea name="textarea" class="form-control" id="default"
